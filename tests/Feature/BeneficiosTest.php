...
class BeneficiosTest extends TestCase
{
    ...
    public function test_beneficios_procesados_endpoint_returns_correct_structure(): void
    {
        Http::fake([
    ...
    public function test_beneficios_procesados_filters_by_min_max_amounts(): void
    {
        Http::fake([
            $this->getBeneficiosUrl() => Http::response([
                'code' => 200,
    ...
    public function test_beneficios_procesados_orders_by_year_desc(): void
    {
        Http::fake([
            $this->getBeneficiosUrl() => Http::response([
                'code' => 200,
    ...
    public function test_beneficios_procesados_calculates_total_amount_correctly(): void
    {
        Http::fake([
            $this->getBeneficiosUrl() => Http::response([
                'code' => 200,
    ...
    public function test_external_api_failure_returns_error(): void
    {
        Http::fake([
    ...
    public function test_beneficios_without_valid_filters_are_excluded(): void
    {
        Http::fake([
            $this->getBeneficiosUrl() => Http::response([
                'code' => 200,
    ...
    public function test_empty_beneficios_returns_empty_array(): void
    {
        Http::fake([
            $this->getBeneficiosUrl() => Http::response([
                'code' => 200,
    ...
    public function test_beneficios_orders_within_year_by_date_asc(): void
    {
        Http::fake([
            $this->getBeneficiosUrl() => Http::response([
                'code' => 200,
    ...
    public function test_multiple_api_failures_returns_error(): void
    {
        Http::fake([
            $this->getBeneficiosUrl() => Http::response([], 500),
