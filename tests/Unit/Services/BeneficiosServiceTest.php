...
class BeneficiosServiceTest extends TestCase
{
    ...
    private \PHPUnit\Framework\MockObject\MockObject $beneficiosRepository;

    private \PHPUnit\Framework\MockObject\MockObject $filtrosRepository;

    private \PHPUnit\Framework\MockObject\MockObject $fichasRepository;
    ...
    public function test_procesar_beneficios_con_datos_validos(): void
    {
        // Arrange
        $beneficios = [
    ...
    public function test_filtrar_beneficios_por_monto_minimo_maximo(): void
    {
    ...
    public function test_beneficios_sin_filtro_son_excluidos(): void
    {
        // Arrange
        $beneficios = [
    ...
    public function test_beneficios_sin_ficha_son_excluidos(): void
    {
        // Arrange
        $beneficios = [
            new BeneficioDTO(123, 25000, '2023-01-15', '2023-01-20'),
    ...
    public function test_ordenamiento_por_ano_descendente(): void
    {
        // Arrange
        $beneficios = [
